      ...
      <section className="border-border b-bottom b-top mt-20 border-dashed py-16 lg:py-20">
        <section className="mx-auto flex max-w-[1440px] flex-col items-center gap-16 px-5">
          ...
          <section className="grid w-full grid-cols-1 gap-6 lg:grid-cols-2 lg:grid-rows-2">
            <article
              className="card-hover flex min-h-[280px] flex-col rounded-2xl bg-[#F6FFFE] p-8"
              data-animate="fade-up"
            >
            ...
            <article
              className="card-hover flex min-h-[280px] flex-col rounded-2xl bg-[#0047A0] p-8"
              data-animate="fade-up"
            ...
            <article
              className="card-hover relative flex min-h-[280px] flex-col overflow-hidden rounded-2xl p-8 lg:col-start-2 lg:col-end-3 lg:row-start-1 lg:row-end-3"
              data-animate="fade-up"
