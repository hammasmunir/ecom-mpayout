...
const Turning = () => {
  ...
  return (
    <section className="border-border b-bottom b-top border-dashed py-16 lg:py-20">
      <section className="mx-auto flex max-w-[1440px] flex-col items-center gap-20 px-5">
        <div className="flex w-full flex-col items-center gap-5 lg:flex-row lg:items-center lg:justify-between">
          ...
          <p className="text-text max-w-[500px] text-center lg:text-left">
            From frozen funds to dedicated MIDs and trusted banking partners. We give businesses the
            foundation to grow safely and confidently.{' '}
          </p>
        </div>
        {data.map((item, idx) => {
