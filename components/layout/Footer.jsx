  ...
  return (
    <footer className="w-full">
      ...
      <div className="w-full border-t border-transparent">
        <div className="border-border b-top mx-auto flex w-full max-w-[1480px] flex-col gap-12 border-dashed lg:flex-row lg:justify-between lg:pl-5">
          {/* LEFT SIDE */}
          ...
          <div className="footer-nav-div flex w-full flex-col lg:max-w-[600px]">
            ...
            <div className="flex flex-col min-[380px]:flex-row min-[380px]:justify-between">
              ...
              <div className="flex grow flex-col gap-2 px-5 py-5 min-[380px]:px-2 sm:px-3 lg:px-10">
                <h3 className="text-base font-medium min-[380px]:text-sm sm:text-lg lg:text-xl">
                  Integrations
                </h3>
                <ul className="text-text flex flex-col gap-2 text-sm min-[380px]:text-xs sm:text-xs lg:text-base">
              ...
              <div className="flex grow flex-col gap-2 py-5 pr-5 pl-5 min-[380px]:pr-2 min-[380px]:pl-2 sm:pr-3 sm:pl-3 lg:pr-0 lg:pl-10">
                <h3 className="text-base font-medium min-[380px]:text-sm sm:text-lg lg:text-xl">
                  Industries
                </h3>
                <ul className="text-text flex flex-col gap-2 text-sm min-[380px]:text-xs sm:text-xs lg:text-base">
            ...
            <div className="flex flex-col min-[380px]:flex-row min-[380px]:justify-between">
              ...
              <div className="flex grow flex-col gap-2 py-5 pr-5 pl-5 min-[380px]:pr-2 min-[380px]:pl-2 sm:pr-3 sm:pl-3 lg:pr-5 lg:pl-10">
                <h3 className="text-base font-medium min-[380px]:text-sm sm:text-lg lg:text-xl">
                  Company
                </h3>
                <ul className="text-text flex flex-col gap-2 text-sm min-[380px]:text-xs sm:text-xs lg:text-base">
      ...
      {/* Bottom Bar */}
      <div className="border-border b-top border-dashed py-7">
